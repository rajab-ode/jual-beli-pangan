...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jun 2022 pada 18.16
...
(31, 142, 'wew', 'bri', 17500, '2022-06-25', '2022062505582620220603183938Drawing10.jpg'),
(32, 143, 'sdsd', 'bri', 3012, '2022-06-25', '2022062506013520220605062508kedelai.jpg');
...
(140, 25, 1, 15, '2022-06-25', 106012, 'JNE', 21000, 'wakatobi', 'Pending', ''),
(141, 25, 1, 23, '2022-06-25', 13512, 'JNE', 6000, 'wakatobi', 'Pending', ''),
(142, 25, 1, 23, '2022-06-25', 17500, 'JNE', 3000, 'wak', 'sudah kirim bukti pembayaran', ''),
(143, 25, 1, 15, '2022-06-25', 3012, 'JNE', 3000, 'qw', 'sudah kirim bukti pembayaran', '');
...
(2, 8, 15, 'Ubi Jalar', 9000, '1 KG', 64, '<p>Ubi Jalar Dengan Harga Satuan ( Kg )</p>\r\n', 'produk1656071439.jpg', 'Balige', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:11:45'),
(4, 8, 15, 'Kacang Tanah', 18000, '1 KG', 299, '<p>Kacang Tanah Kualitas Bagus Dengan Harga Satuan ( Kg )</p>\r\n', 'produk1656056083.jpg', 'Balige', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:11:45'),
(5, 8, 15, 'Kedelai', 18500, '1 KG', 87, '<p>Kacang Kedelai Berkualitas Dengan Harga Satuan ( Kg )</p>\r\n', 'produk1656056069.jpg', 'Balige', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:11:45'),
(6, 8, 15, 'Beras Putih', 17500, '1 Kg', 94, '<p>Beras Putih Berkualitas Dengan Harga Satuan ( Kaleng )</p>\r\n', 'produk1656071427.jpg', 'Balige', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:11:45'),
(7, 8, 23, 'Bawang Merah', 14500, '1 Kg', 1597, '<p>Bawang Merah Berkualitas Dengan Harga Satuan ( Kg )</p>\r\n', 'produk1656069269.jpg', '', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:57:41'),
(14, 8, 23, 'Cabe Merah', 7500, '1 Kg', 2997, 'Cabai merah harga satuan per Kg', 'produk1656008547.jpg', '', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 03:51:53'),
(21, 8, 15, 'qwq', 12, '12', 9, '<p>weq</p>\r\n', 'produk1656098022.jpg', '', 'https://api.whatsapp.com/send?phone=6285220832295 &text= Hai, saya tertarik dengan produk Anda.', 1, '2022-06-25 04:01:00');
...
--
ALTER TABLE `pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;

--
-- AUTO_INCREMENT untuk tabel `pembelian_produk`
--
ALTER TABLE `pembelian_produk`
  MODIFY `id_pembelian_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
